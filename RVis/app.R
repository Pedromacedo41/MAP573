...
xd1= t(fread("./Data/Model_predictions/bidirectionallstm_predictor_168h_window672_37708_38212.csv", sep=","))
xd2=t(fread("./Data/Model_predictions/lstm_predictor_1h_window100_0_39575.csv", sep=","))
xd3= t(fread("./Data/Model_predictions/lstm_predictor_24h_window100_32660_32784.csv", sep=","))
xd4= t(fread("./Data/Model_predictions/lstm_predictor_168h_window1000_32160_33328.csv", sep=","))
xd1= data.frame(xd1)
xd2= data.frame(xd2)
xd3= data.frame(xd3)
xd4= data.frame(xd4)
